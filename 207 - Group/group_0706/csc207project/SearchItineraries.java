...
import flightapp.*;
/**
 * An activity where users can enter search parameters for searching for a itinerary.
 */
public class SearchItineraries extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateDisplay = (TextView) findViewById(R.id.textViewDateDisplay);
        pickDate = (Button) findViewById(R.id.buttonPickDate);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_search_itineraries, menu);
        return true;
    }
    ...
    /**
     * Goes to the SearchResults activity and gives it the flightApp, user, true if the user
